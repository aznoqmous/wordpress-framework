...
use Addictic\WordpressFrameworkBundle\Annotation\PostTypeManager;
use Addictic\WordpressFrameworkBundle\Helpers\PostPostQueryBuilder;
use Addictic\WordpressFrameworkBundle\Helpers\PostQueryBuilder;
use Addictic\WordpressFrameworkBundle\Helpers\QueryBuilder;
...
abstract class AbstractPostTypeModel extends AbstractModel
{
    ...
    public function getFrontendUrl()
    {
        ...
        $prefix = $currentLanguage != wpml_get_default_language() ? "/{$currentLanguage}" : "";
